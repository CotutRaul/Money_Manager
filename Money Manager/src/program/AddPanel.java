...
public class AddPanel {
	...
	public AddPanel()
	{
		...
		addLabel.setIcon(new ImageIcon("assets/plus.png"));
	...
	public void addMoney()
	{
		...
		{  
			...
			public void mouseClicked(MouseEvent e) {
				try {
					String sql = "insert into MoneyManager (mdate,name,price) values(to_date('" + dateField.getText() + "','DD/MM/YYYY'),'" + nameField.getText() + "','" + priceField.getText() + "')";
