...
public class Money{
	 ...
	 * 
	 * @param position an integer that represents the position in the ArrayList and in the money panel.
	...
	/**
	 * Method that is called when the user clicks on an income or an expense. This method creates a pop-up where the user can edit or delete that selection.
	 */
	public void editMoney()
	{
		...
		{  
			...
			public void mouseClicked(MouseEvent e) {
				try
				{
					String sql="update moneymanager set mdate=to_date('"+dateField.getText()+"','DD/MM/YYYY'), name='"+ nameField.getText() +"', price="+priceField.getText()+" where id="+ ID;
